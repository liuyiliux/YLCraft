...
const themes: Record<string, ThemeDefinition> = {
  ...
  deep: {
    ...
    antdComponents: {
      ...
      Card: { colorBgContainer: '#16161a', colorBorderSecondary: 'rgba(255,255,255,0.06)', actionsBg: '#111117', colorText: '#71717a', borderRadiusLG: 16 },
      Input: { colorBgContainer: '#1f1f27', colorBorder: 'rgba(255,255,255,0.12)', colorText: '#e4e4e7', colorTextPlaceholder: '#52525b', borderRadius: 8 },
      ...
      Select: { colorBgContainer: '#1f1f27', colorBorder: 'rgba(255,255,255,0.12)', colorText: '#e4e4e7', colorTextPlaceholder: '#52525b', colorTextTertiary: '#71717a', colorTextQuaternary: '#71717a', borderRadius: 8 },
      Tabs: { colorText: '#71717a', colorTextActive: '#22d3ee' },
      Typography: { colorTextSecondary: '#71717a' },
    },
  },
