# agent-center-conversation-workbench Specification

## Purpose
TBD - created by archiving change agent-center-conversation-workbench-redesign. Update Purpose after archive.
## Requirements
