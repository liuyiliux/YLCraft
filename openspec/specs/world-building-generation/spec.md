# world-building-generation Specification

## Purpose
TBD - created by archiving change ai-progressive-world-building. Update Purpose after archive.
## Requirements
### Requirement: 从想法生成世界骨架
...
<!-- 原编号 R4（见 proposal 的 R 编号体系） -->

### Requirement: 提示词可编辑与预览
...
<!-- 原编号 R6（见 proposal 的 R 编号体系） -->

### Requirement: 生成与提取的语义隔离
