...
1. 不要只替换同义词，先定位概念化总结、解释替代行动和重复句式。
2. 补入可被看见、听见、触摸到的细节，但不能凭空增加事件、事实或人物信息。
3. 对白要有遮掩、试探、误会和反应差，不要让人物把动机直接讲完。
4. 保留原事件顺序，控制解释密度，让段落长短有变化；不要为了“不规则”而制造病句。
5. 不要机械删除排比、三段式、短句、比喻或常见连接词。只有当它们在当前正文中反复出现、替代戏剧动作或破坏人物声音时才改。
6. 先保持人物目标、冲突、事实和章末后果，再调整语气、节奏、留白和修辞。
