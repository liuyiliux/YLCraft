...
| --- | --- | --- | --- | --- |
| `GET` | `/api/v1/previs/motions` | List reusable previs motion assets | `list_previs_motions` | `backend/app/api/v1/previs.py:295` |
| `GET` | `/api/v1/previs/scenes` | List previs scenes | `list_previs_scenes` | `backend/app/api/v1/previs.py:119` |
| `POST` | `/api/v1/previs/scenes` | Create previs scene | `create_previs_scene` | `backend/app/api/v1/previs.py:137` |
| `GET` | `/api/v1/previs/scenes/{scene_id}` | Get previs scene | `get_previs_scene` | `backend/app/api/v1/previs.py:173` |
| `PUT` | `/api/v1/previs/scenes/{scene_id}` | Save previs scene with revision check | `save_previs_scene` | `backend/app/api/v1/previs.py:242` |
| `DELETE` | `/api/v1/previs/scenes/{scene_id}` | Delete previs scene | `delete_previs_scene` | `backend/app/api/v1/previs.py:279` |
| `POST` | `/api/v1/previs/scenes/{scene_id}/capture` | 回流当前机位截图到 Asset Hub 并关联分镜面板 | `capture_previs_scene` | `backend/app/api/v1/previs.py:335` |
